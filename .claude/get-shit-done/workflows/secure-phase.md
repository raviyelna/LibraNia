...
```
Agent(
  prompt="Read /home/user1/LibraNia/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user1/LibraNia/.claude/get-shit-done/templates/SECURITY.md`
