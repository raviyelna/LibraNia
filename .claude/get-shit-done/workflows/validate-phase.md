...
```
Agent(
  prompt="Read /home/user1/LibraNia/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user1/LibraNia/.claude/get-shit-done/templates/VALIDATION.md`
