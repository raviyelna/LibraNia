...
```markdown
Read /home/user1/LibraNia/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user1/LibraNia/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user1/LibraNia/.claude/agents/gsd-ui-checker.md for instructions.
