...
<execution_context>
@/home/user1/LibraNia/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user1/LibraNia/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
