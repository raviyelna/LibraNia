...
<required_reading>
@/home/user1/LibraNia/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user1/LibraNia/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user1/LibraNia/.claude
                  → checks /home/user1/LibraNia/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user1/LibraNia/.claude/get-shit-done
                  → writes to /home/user1/LibraNia/.claude/get-shit-done/hooks/
...
@/home/user1/LibraNia/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user1/LibraNia/.claude/get-shit-done/references/common-bug-patterns.md
