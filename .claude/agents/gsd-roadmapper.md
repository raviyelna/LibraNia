...
Reference full template: `/home/user1/LibraNia/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user1/LibraNia/.claude/get-shit-done/templates/state.md`.
